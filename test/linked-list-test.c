...
int main()
{
    ...
    printf("Insert after \"this data should overflow in most buffers\"\n");
    ...
    printf("Insert after \"another long data to overflow buffers\"\n");
    ...
    printf("Insert before \"small data\"\n");
    ...
    printf("Insert after \"lorem ipsum something something\"\n");
    ...
    printf("Insert before \"blah blah blah\"\n");

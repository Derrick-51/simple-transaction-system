...
test/linked-list-menu-test.out: intermediates/linked-list-menu-test.o intermediates/linked-list.o
	gcc -o test/linked-list-menu-test.out intermediates/linked-list-menu-test.o intermediates/linked-list.o

test/linked-list-test.out: intermediates/linked-list-test.o intermediates/linked-list.o
	gcc -o test/linked-list-test.out intermediates/linked-list-test.o intermediates/linked-list.o
